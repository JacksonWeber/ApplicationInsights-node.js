...
# RUN npm install opentelemetry-exporter-metrics-otlp-http-0.205.0.tgz
# RUN npm install opentelemetry-otlp-exporter-base-0.205.0.tgz
# RUN npm install opentelemetry-otlp-transformer-0.205.0.tgz
